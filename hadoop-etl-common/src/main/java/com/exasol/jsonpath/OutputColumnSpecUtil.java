...
public class OutputColumnSpecUtil {
     ...
     *
     * @param outputSpecification A comma separated list of output columns and optional JsonPath
     *     suffixes. The whole path is case sensitive.
     */
    public static List<OutputColumnSpec> parseOutputSpecification(
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    ...
                    + e.toString() + "' for output specification: " + outputSpecification, e);
        }
    ...
    private static int findColumnPositionByName(
        ...
        throw new RuntimeException(
                ...
                + ". Note that the columns are case-sensitive");
    }
     ...
     *
     * <p>Example: Return true if left path is 'field1[0]', and the right path is
     * 'field1[0].field2.
     */
