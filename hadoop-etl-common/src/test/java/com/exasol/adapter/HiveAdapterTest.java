...
public class HiveAdapterTest {
    ...
    public void testReadMetadata() throws SQLException, MetadataException {
        ...
        SchemaMetadataInfo schemaMetadataInfo =
            new SchemaMetadataInfo("DUMMY_SCHEMA", "", properties);

        ExaConnectionInformation connectionInfo =
        ...
        SchemaMetadata schemaMetadata =
            HiveAdapter.readMetadata(schemaMetadataInfo, connectionInfo, null, null);
