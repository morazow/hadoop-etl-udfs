...
/**
 * Writes files to (web)HDFS using the appropriate Hadoop OutputFormat
 * and Hive SerDe.
 */
public class HdfsSerDeExportService {
    ...
    public static void exportToParquetTable(
            ...
            // Defined in parquet.hadoop.metadata.CompressionCodecName.java
        ...
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
            public Void run() throws Exception {
                if (ctx.size() > 0) {
                    ...
                    Configuration conf = HdfsService.getHdfsConfiguration(
                    ...
                    if (tableMeta != null) {
                        ...
                        parquetWriter = new ExaParquetWriterImpl(
                                metaColNames,
                                metaColTypes,
                                conf,
                                path,
