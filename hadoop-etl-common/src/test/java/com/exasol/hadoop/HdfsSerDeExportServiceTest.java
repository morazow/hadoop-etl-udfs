...
public class HdfsSerDeExportServiceTest {
  ...
  static final int FIRST_DATA_COLUMN =
      11; // UDF argument number that has the first data column (see ExportIntoHiveTable class)
  ...
  public void testExportParquetNumeric() throws Exception {
    ...
    File tempFile =
        new File(testFolder.getRoot(), UUID.randomUUID().toString().replaceAll("-", "") + ".parq");
