...
public class HiveQueryGenerator {
    ...
    public static String getOutputSql(
            SchemaMetadataInfo meta,
            Table table,
            String partitionString,
            String outputColumnsString,
            String selectedColumnsString,
            String selectListPart,
            String secondPart,
            ExaConnectionInformation connection) throws SQLException {
        String credentialsAndConn = "";
        credentialsAndConn +=
            "HCAT_DB = '" + HiveAdapterProperties.getSchema(meta.getProperties()) + "'";
        ...
        return "SELECT "
            ...
            + ")"
            + " FROM SCRIPT ADAPTERSCHEMA.IMPORT_HCAT_TABLE WITH "
            + credentialsAndConn
            + ")"
            + secondPart;
    }
    ...
    public static String getWhereClause(
            SqlStatementSelect select, SqlGeneratorForWhereClause sqlGeneratorForWhereClause)
