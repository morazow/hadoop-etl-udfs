...
public class WebHdfsAndHCatService {
    ...
    public static String getExtendedTableInfo(
            String webHCatServer,
            String dbName, String tableName, String hcatUser) throws Exception {
        ...
        return get(WebHdfsAndHCatService.Service.HCAT,
                webHCatServer, requestPath, requestQuery, hcatUser);
    }

    private static String buildUrl(
            Service service, String serverAndPort, String path, String query, String user) {
        String urlStr = "";
        switch (service) {
            case HDFS:
    ...
    public static String get(
            Service service,
            String serverAndPort, String path, String query, String user) throws Exception {
        ...
        try {
            ...
            throw new RuntimeException("Problem accessing web"
                    + service.toString() + " (" + urlStr + "): " + e.getMessage(), e);
        } finally {
            if (httpConn != null) {
                httpConn.disconnect();
            }
