...
public class ExportHCatTableTest {
    ...
    public void testGenerateSqlForExportSpecMandatory() {
        ...
        String sqlExpected =
            ...
            + "\".\"EXPORT_INTO_HIVE_TABLE\"("
            + "'hcat_db', 'hcat_table', '', 'hdfs_user', 'hcat_user', "
            + "'', '', '', '', '', 'uncompressed', 'false', ''"
            + ", \"COL1\""
            + ") "
            + "FROM "
    ...
    public void testGenerateSqlForExportStaticPartition() {
        ...
        String sqlExpected =
            ...
            + "\".\"EXPORT_INTO_HIVE_TABLE\"("
            + "'hcat_db', 'hcat_table', '', 'hdfs_user', 'hcat_user', '', "
            + "'part1=2015-01-01/part2=EU', '', '', '', 'uncompressed', 'false', ''"
            + ", \"COL1\""
            + ") "
            + "FROM "
            + "DUAL;";
    ...
    public void testGenerateSqlForExportDynamicPartition() {
        ...
        String sqlExpected =
            ...
            + meta.getScriptSchema()
            + "\".\"EXPORT_INTO_HIVE_TABLE\"("
            + "'hcat_db', 'hcat_table', '', 'hdfs_user', 'hcat_user', '', '', '1,2', "
            + "'', '', 'uncompressed', 'false', ''"
            + ", \"COL1\", \"col2\", \"COL3\""
            + ") "
            + "FROM "
    ...
    public void testGenerateSqlForExportMissingProperty() {
        ...
        thrown.expect(RuntimeException.class);
        thrown.expectMessage("The mandatory property HCAT_TABLE was not defined. "
