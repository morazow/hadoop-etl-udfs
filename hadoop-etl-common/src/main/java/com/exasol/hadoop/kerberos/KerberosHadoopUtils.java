...
public class KerberosHadoopUtils {
  ...
  public static UserGroupInformation getKerberosUGI(final KerberosCredentials kerberosCredentials)
      throws Exception {
   ...
   */
  public static void configKerberosJaas(String path, String user, String password)
      throws Exception {
