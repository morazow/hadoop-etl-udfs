...
public class HCatMetadataServiceTest {
  ...
  public void testGetPartitionPaths() throws Exception {
    ...
    pathsAndContent.put(
        rootPath + "/y=2001",
        Arrays.asList(
            fakeFileStatus(rootPath + "/y=2001/m=01"), fakeFileStatus(rootPath + "/y=2001/m=02")));
    ...
    pathsAndContent.put(
        rootPath + "/y=2003",
        Arrays.asList(
            fakeFileStatus(rootPath + "/y=2003/m=01"), fakeFileStatus(rootPath + "/y=2003/m=11")));
  ...
  private void testGetPartitionPathsScenario(
    ...
    List<String> paths =
        HdfsService.getPartitionPaths(
            fs, rootPath, partitionColumns, MultiPartitionFilter.parseMultiFilter(filter));
  ...
  public void testPartitionPathFilter() {
    ...
    List<String> filteredPaths1 =
        fakeFilterPaths(pathsPartition1, new PartitionPathFilter(partitionColumns, multiFilter, 1));
    ...
    List<String> filteredPaths2 =
        fakeFilterPaths(pathsPartition2, new PartitionPathFilter(partitionColumns, multiFilter, 2));
